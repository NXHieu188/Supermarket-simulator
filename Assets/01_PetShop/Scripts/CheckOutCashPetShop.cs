...
public class CheckOutCashPetShop : MonoBehaviour
{
    ...
    void CheckComplete()
    {
        ...
        if (priceGiving.ToString() == GlobalGameManagerPetShop1.Instance.gameManagerInstance.currentCustomer.change.ToString())
        {
            GlobalGameManagerPetShop1.Instance.gameManagerInstance.txtGivingCashDF.color = Color.green;
            GlobalGameManagerPetShop1.Instance.gameManagerInstance.txtGivingCash.color = Color.green;
        }
        else
        {
            GlobalGameManagerPetShop1.Instance.gameManagerInstance.txtGivingCashDF.color = Color.red;
            GlobalGameManagerPetShop1.Instance.gameManagerInstance.txtGivingCash.color = Color.red;
        }
        GlobalGameManagerPetShop1.Instance.gameManagerInstance.txtGivingCash.text = "$" + priceGiving.ToString("0.00");
    }
    ...
    public void OnClickReset()
    {
        //listPrice = new List<float>();
        priceGiving = 0;
        GlobalGameManagerPetShop1.Instance.gameManagerInstance.txtGivingCash.text = "$0";
    }
