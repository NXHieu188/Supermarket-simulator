...
public static class HelperUtility
{
    ...
    /// <returns></returns>
    public static Vector3 GetPointDistanceFromObject(float distance, [Bridge.Ref] Vector3 direction, [Bridge.Ref] Vector3 fromPoint)
    {
        distance -= 1;
        //if (distance < 0)
        //    distance = 0;
    ...
    /// <returns></returns>
    public static Vector3 GetDirectionFromAngle([Bridge.Ref] Vector3 vectorP, float angle, [Bridge.Ref] Vector3 positionStart)
    {
        if (angle == 90)
        {
    ...
    /// <param name="positionStart"></param>
    /// <returns></returns>
    public static Vector3 GetDirectionFromAngle_2([Bridge.Ref] Vector3 vectorP, float angle, [Bridge.Ref] Vector3 positionStart)
    {
        if (angle == 90)
        {
            return new Vector3(vectorP.y, -vectorP.x).normalized;
    ...
    public static IEnumerator DOLocalRotateQuaternion([Bridge.Ref] Quaternion endValue, float speedRotate, GameObject objLookAt,
    ...
    public static bool GetRotateDirection([Bridge.Ref] Quaternion from, [Bridge.Ref] Quaternion to)
    {
    ...
    public static void LookAtToDirection([Bridge.Ref] Vector3 diretion, GameObject objLookAt, float speedLockAt = 500)
    {
    ...
    public static void LookAtToDirectionAngleDetal([Bridge.Ref] Vector3 diretion, GameObject objLookAt, float AngleDetal, float speedLockAt = 500)
    {
        float xTarget = diretion.x;
        float yTarget = diretion.y;
    ...
    public static void LookAtToPosition([Bridge.Ref] Vector3 position, GameObject objLookAt, float speedRotate = 500)
    {
    ...
    public static void LookAtToPositionAngleDetal([Bridge.Ref] Vector3 position, GameObject objLookAt, float AngleDetal, float speedRotate = 500)
    {
        float xTarget = position.x - objLookAt.transform.position.x;
    ...
    public static float ParseFloat(string value, float defaultValue = 0)
    {
        if (value.Contains(","))
            value = value.Replace(",", ".");
        float tmpFloat = defaultValue;
        float.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture.NumberFormat, out tmpFloat);
        return tmpFloat;
    }
    public static float RoundFloat2(this float value)
    {
...
public static class MMMaths
{
    ...
    public static Vector2 Vector3ToVector2([Bridge.Ref] Vector3 target)
    {
    ...
    public static Vector3 Vector2ToVector3([Bridge.Ref] Vector2 target)
    {
    ...
    public static Vector3 Vector2ToVector3([Bridge.Ref] Vector2 target, float newZValue)
    {
    ...
    public static Vector3 RandomVector3([Bridge.Ref] Vector3 minimum, [Bridge.Ref] Vector3 maximum)
    {
    ...
    public static Vector3 RotatePointAroundPivot([Bridge.Ref] Vector3 point, [Bridge.Ref] Vector3 pivot, float angle)
    {
    ...
    public static Vector3 RotatePointAroundPivot([Bridge.Ref] Vector3 point, [Bridge.Ref] Vector3 pivot, [Bridge.Ref] Vector3 angle)
    {
